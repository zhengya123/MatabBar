...
-(UITabBarController *)createTabBarController{
    ...
    //设置tabBar对应的图片
    oneNav.tabBarItem.image=[UIImage imageNamed:@"tabbar_home"];
    oneNav.tabBarItem.selectedImage=[UIImage imageNamed:@"tabbar_home_selected"];
    twoNav.tabBarItem.image=[UIImage imageNamed:@"tabbar_message_center"];
    twoNav.tabBarItem.selectedImage=[UIImage imageNamed:@"tabbar_message_center_selected"];
    threeNav.tabBarItem.image=[UIImage imageNamed:@"tabbar_discover"];
    threeNav.tabBarItem.selectedImage=[UIImage imageNamed:@"tabbar_discover_selected"];
    fourNav.tabBarItem.image=[UIImage imageNamed:@"tabbar_profile"];
    fourNav.tabBarItem.selectedImage=[UIImage imageNamed:@"tabbar_profile_selected"];
